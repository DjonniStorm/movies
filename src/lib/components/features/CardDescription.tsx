...
export const CardDescription = ({ id }: CardDescriptionProps): JSX.Element => {
    ...
    return (
        <div className="flex-1 p-10 w-full h-full">
            <div className="border border-black rounded-2xl flex w-full h-full p-5">
                <div className="pr-5 border-r flex justify-center items-center w-100 overflow-hidden">
                    <ImageComponent
                        src={poster.url}
                        alt={name + 'poster'}
                        width={150}
                ...
                <div className="w-full h-full p-5 flex flex-col justify-center gap-y-10">
                    ...
                    <div>
                        <div className="p-2 text-justify">{description}</div>
